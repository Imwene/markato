...
router.get("/business-settings", getBusinessSettings); // Public for frontend booking form
router.put("/business-settings", protect, adminOnly, updateBusinessSettings);
