...
const FeatureSection = () => {
  return (
    <div
      id="why-choose-us"
      className="relative mt-10 border-b border-border-light min-h-[800px]"
    >
      <div className="text-center">
        <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-6 lg:mt-10 tracking-wide font-bold text-content-dark">
          Why Choose{" "}
        ...
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
            <div className="flex group p-6 hover:bg-background-dark rounded-lg transition-colors">
              <div
                className="flex mx-6 h-10 w-10 p-2 bg-primary-light/10 text-primary-DEFAULT 
