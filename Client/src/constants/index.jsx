...
export const features = [
  ...
  },
  {
    ...
    text: "Transparency",
    description:
      "We offer you our affordable rates, because we have built our business on trust.",
  },
  {
    icon: <ShieldHalf />,
    text: "Quality",
    description:
      "We are committed to quality and take vehicle detailing seriously. Top-notch service is our main auto motive.",
  },
  {
    icon: <BatteryCharging />,
    text: "Skilled Detailers",
...
export const checklistItems = [
  ...
  {
    title: "Select your Optional Services",
    description: "Add any additional services you may need",
  },
  {
